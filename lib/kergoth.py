        ...
        def data_for_hash(key):
            ...
            if valstr is not None:
                try:
                    ...
                    if hasattr(value, "function_references"):
                        for funcname, funcref in value.function_references:
                            bb.msg.note(1, None, "Adding function %s to the signature" % funcname)
                            yield funcname, pickle.dumps(funcref)
